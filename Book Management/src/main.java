...
public class main {
                ...
                else if(password.equals("")) //If password is null
                {
                    ...
                    try
                    {
                        ...
                        if (rs.next()){
                            ...
                            //f.dispose();
                            //rs.last();  //Move the pointer above
                            ...
                            JOptionPane.showMessageDialog(null,"Error"); //Display Message
                        }
                    }
                    catch (Exception ex) {
                        ex.printStackTrace();
    ...
    public static Connection connect()
    {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql?user=root&password=mrsacheen");
